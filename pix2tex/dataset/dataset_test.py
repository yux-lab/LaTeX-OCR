...
class Im2LatexDatasetTest:
    ...
    def __init__(self, equations=None, images=None, tokenizer=None, shuffle=False, batchsize=16, max_seq_len=1024,
...
if __name__ == '__main__':
    ...
    if args.images is None and args.equations is not None:
        ...
        for images, equations in zip(args.images, args.equations):
            if dataset is None:
                dataset = Im2LatexDatasetTest(equations, images, args.tokenizer)
            else:
                dataset.combine(Im2LatexDatasetTest(equations, images, args.tokenizer))
